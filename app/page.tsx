  ...
  return (
    <>
      ...
      <main className="pb-16">
        ...
        <section className="mx-auto mt-4 max-w-7xl px-4 md:px-6">
          <div className="overflow-hidden rounded-[34px] border border-[#cad8df] bg-white shadow-[0_18px_44px_rgba(15,35,45,0.16)]">
            <div className="grid md:grid-cols-2">
              <div className="bg-[radial-gradient(circle_at_top_left,#1f7390_0%,#0f5c73_58%,#0c4a5e_100%)] px-6 py-10 text-white md:px-10 md:py-14">
        ...
        <section className="mx-auto mt-14 max-w-7xl px-4 md:px-6">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {sectionHighlights.map((section) => (
              <article key={section.href} className="smooth-card rounded-2xl p-6">
        ...
        <section className="mx-auto mt-14 max-w-7xl px-4 md:px-6">
          <div className="smooth-surface grid items-center gap-8 rounded-3xl p-7 md:grid-cols-2 md:p-10">
            <div>
