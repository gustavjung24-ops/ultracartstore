...
export const AUTHOR_PROFILES: AuthorProfile[] = [
  {
    ...
    shortBio: "Neal Barnard là bác sĩ và nhà nghiên cứu về dinh dưỡng, hiện là Chủ tịch Physicians Committee for Responsible Medicine và Adjunct Professor of Medicine tại George Washington University School of Medicine. Ông tập trung vào y học dự phòng, dinh dưỡng dựa trên thực vật và các chuẩn mực đạo đức cao hơn trong nghiên cứu.",
    degrees: ["MD", "FACC"],
    specialty: ["Y khoa", "dinh dưỡng lâm sàng", "y học dự phòng"],
    currentRole: "President",
    currentOrganization: "Physicians Committee for Responsible Medicine; George Washington University School of Medicine",
    professionalFocus: [
      "Y học dự phòng",
    ...
    relatedArticleSlugs: [],
    profileSourceLinks: [
      { label: "PCRM", url: "https://www.pcrm.org/about-us/staff/neal-barnard-md-facc" }
    ],
    externalLinks: [],
    socialLinks: [],
    featured: true,
  ...
  },
  {
    ...
    shortBio: "Hana Kahleova là Director of Clinical Research tại PCRM. Công việc của bà tập trung vào ảnh hưởng của lựa chọn thực phẩm đối với kháng insulin, chuyển hóa và điều hòa cân nặng lành mạnh.",
    degrees: ["MD", "PhD"],
    ...
    professionalFocus: [
      "Nghiên cứu lâm sàng về chế độ ăn thực vật",
      "chuyển hóa",
      "insulin",
      "kiểm soát cân nặng"
    ],
    ...
    relatedArticleSlugs: [],
    profileSourceLinks: [
      { label: "PCRM", url: "https://www.pcrm.org/about-us/staff/hana-kahleova" }
    ],
    externalLinks: [],
    socialLinks: [],
    featured: true,
  ...
  },
  {
    ...
    shortBio: "Amy Lanou là Senior Nutrition Scientist tại PCRM, đồng thời là professor of health and wellness tại UNC Asheville và editor in chief của PlantPure Magazine. Bà nghiên cứu mối liên hệ giữa chế độ ăn dựa trên thực vật và nguy cơ bệnh mạn tính.",
    degrees: ["PhD"],
    specialty: ["Dinh dưỡng", "sức khỏe xương", "truyền thông sức khỏe", "chính sách dinh dưỡng"],
    currentRole: "Senior Nutrition Scientist",
    currentOrganization: "Physicians Committee for Responsible Medicine; University of North Carolina-Asheville",
    professionalFocus: [
      "Dinh dưỡng dựa trên thực vật",
    ...
    relatedArticleSlugs: [],
    profileSourceLinks: [
      { label: "PCRM", url: "https://www.pcrm.org/about-us/staff/amy-lanou" }
    ],
    externalLinks: [],
    socialLinks: [],
    featured: true,
  ...
  },
  {
    ...
    shortBio: "Janine McCarthy là Acting Director of Research Policy tại PCRM. Bà tập trung vào integrity trong nghiên cứu, chính sách thay thế thí nghiệm trên động vật và thúc đẩy các phương pháp nghiên cứu human-specific, nonanimal.",
    degrees: ["MPH"],
    ...
    relatedArticleSlugs: [],
    profileSourceLinks: [
      { label: "PCRM", url: "https://www.pcrm.org/about-us/staff/janine-mccarthy" }
    ],
    externalLinks: [],
    socialLinks: [],
    featured: true,
  ...
  },
  {
    ...
    shortBio: "Roxanne Becker là Medical Editor and Educator tại PCRM. Bà tốt nghiệp y khoa tại University of Cape Town, có diploma in Lifestyle Medicine và chứng chỉ về plant-based nutrition.",
    ...
    currentOrganization: "Physicians Committee for Responsible Medicine",
    professionalFocus: [
      "Giáo dục y khoa về dinh dưỡng thực vật và lifestyle medicine",
      "biên tập nội dung y khoa"
    ],
    researchInterests: [
      "diabetes",
      "weight loss",
    ...
    relatedArticleSlugs: [],
    profileSourceLinks: [
      { label: "PCRM", url: "https://www.pcrm.org/about-us/staff/roxanne-becker" }
    ],
    externalLinks: [],
    socialLinks: [],
    featured: true,
